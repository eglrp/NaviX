        ...
        first_reconfigure_call_(true)
{
  ...
  private_nh_.param("odom_model_type", tmp_model_type, std::string("omni"));
  ...
  pose_pub_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped>("amcl_pose", 1, true);
  particlecloud_pub_ = nh_.advertise<geometry_msgs::PoseArray>("particlecloud", 2, true);
  global_loc_srv_ = nh_.advertiseService("global_localization", &AmclNode::global_localization_callback, this);
...
bool AmclNode::global_localization_callback(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res)
{
  if( map_ == NULL )
  {
    return true;
...
//     fflush(stdout);
      ...
      ROS_INFO("New amcl pose: %6.3f %6.3f %6.3f,and cov %6.3f %6.3f %6.3f",
               hyps[max_weight_hyp].pf_pose_mean.v[0],
               hyps[max_weight_hyp].pf_pose_mean.v[1],
               hyps[max_weight_hyp].pf_pose_mean.v[2],
               hyps[max_weight_hyp].pf_pose_cov.m[0][0],
...
{
    //convarience as larger as sepreate.
