...
if("TRUE" STREQUAL "TRUE")
  set(urg_c_SOURCE_PREFIX /home/bailiqun/urg_node/urg_c)
  set(urg_c_DEVEL_PREFIX /home/bailiqun/urg_node/build/devel)
  set(urg_c_INSTALL_PREFIX "")
  set(urg_c_PREFIX ${urg_c_DEVEL_PREFIX})
else()
  set(urg_c_SOURCE_PREFIX "")
  set(urg_c_DEVEL_PREFIX "")
  set(urg_c_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/bailiqun/urg_node/urg_c/current/include " STREQUAL " ")
  set(urg_c_INCLUDE_DIRS "")
  set(_include_dirs "/home/bailiqun/urg_node/urg_c/current/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/urg_node/urg_c/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
