...
if("TRUE" STREQUAL "TRUE")
  set(map_msgs_SOURCE_PREFIX /home/bailiqun/NaviX/modules/msgs/navigation_msgs/map_msgs)
  set(map_msgs_DEVEL_PREFIX /home/bailiqun/NaviX/build/devel)
  set(map_msgs_INSTALL_PREFIX "")
  set(map_msgs_PREFIX ${map_msgs_DEVEL_PREFIX})
else()
  set(map_msgs_SOURCE_PREFIX "")
  set(map_msgs_DEVEL_PREFIX "")
  set(map_msgs_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/bailiqun/NaviX/build/devel/include " STREQUAL " ")
  set(map_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/bailiqun/NaviX/build/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/NaviX/modules/msgs/navigation_msgs/map_msgs/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
set(map_msgs_EXPORTED_TARGETS "map_msgs_generate_messages_cpp;map_msgs_generate_messages_eus;map_msgs_generate_messages_lisp;map_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_msgs_dep}_FOUND)
      find_package(${map_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_msgs_dep} REQUIRED ${depend_list})
  endif()
