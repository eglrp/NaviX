...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/bailiqun/NaviX/modules/recovery/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/bailiqun/NaviX/build/devel)
...
if(NOT "/home/bailiqun/NaviX/modules/recovery/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/bailiqun/NaviX/modules/recovery/clear_costmap_recovery/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/NaviX/modules/recovery/clear_costmap_recovery/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
set(depends "pluginlib;roscpp;tf")
