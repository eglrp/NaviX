...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/bailiqun/NaviX/modules/slam/amcl)
  set(amcl_DEVEL_PREFIX /home/bailiqun/NaviX/build/devel)
...
if(NOT "/home/bailiqun/NaviX/build/devel/include;/home/bailiqun/NaviX/modules/slam/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/bailiqun/NaviX/build/devel/include;/home/bailiqun/NaviX/modules/slam/amcl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/NaviX/modules/slam/amcl/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
