  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wellcasa <bailiqun@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/NaviX/modules/slam/amcl/${idir}'.  Ask the maintainer 'wellcasa <bailiqun@gmail.com>' to fix it.")
    endif()
