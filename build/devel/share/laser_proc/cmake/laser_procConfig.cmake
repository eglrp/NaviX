...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/bailiqun/NaviX/modules/driver/urg_node/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/bailiqun/NaviX/build/devel)
  ...
  set(laser_proc_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/bailiqun/NaviX/modules/driver/urg_node/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/bailiqun/NaviX/modules/driver/urg_node/laser_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bailiqun/NaviX/modules/driver/urg_node/laser_proc/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
    endif()
