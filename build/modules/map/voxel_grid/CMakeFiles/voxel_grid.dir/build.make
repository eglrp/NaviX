...
modules/map/voxel_grid/libvoxel_grid.so: modules/map/voxel_grid/CMakeFiles/voxel_grid.dir/src/voxel_grid.cpp.o
modules/map/voxel_grid/libvoxel_grid.so: modules/map/voxel_grid/CMakeFiles/voxel_grid.dir/build.make
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/libroscpp.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_signals.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_filesystem.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/librosconsole.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/librosconsole_log4cxx.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/librosconsole_backend_interface.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/liblog4cxx.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_regex.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/libroscpp_serialization.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/librostime.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_date_time.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/libxmlrpcpp.so
modules/map/voxel_grid/libvoxel_grid.so: /opt/ros/indigo/lib/libcpp_common.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_system.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libboost_thread.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libpthread.so
modules/map/voxel_grid/libvoxel_grid.so: /usr/lib/x86_64-linux-gnu/libconsole_bridge.so
modules/map/voxel_grid/libvoxel_grid.so: modules/map/voxel_grid/CMakeFiles/voxel_grid.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/bailiqun/NaviX/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library libvoxel_grid.so"
...
modules/map/voxel_grid/CMakeFiles/voxel_grid.dir/build: modules/map/voxel_grid/libvoxel_grid.so
